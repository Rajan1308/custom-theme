...
if ( ! function_exists( 'beco_adjust_body_class' ) ) {
	 ...
	 */
	function beco_adjust_body_class( $classes ) {
...
if ( ! function_exists( 'beco_slbd_count_widgets' ) ) {
	/**
	 ...
	 * @deprecated 0.8.9
	 */
	function beco_slbd_count_widgets( $sidebar_id ) {
...
function deprecated_translations() {
	array(
		__( 'It looks like nothing was found at this location. Maybe try one of the links below or a search?', 'beco' ),
		__( 'Previous', 'beco' ),
		__( 'Next', 'beco' ),
		__( 'About:', 'beco' ),
		__( 'Profile', 'beco' ),
		__( 'Posts by', 'beco' ),
		__( 'Permanent Link:', 'beco' ),
		__( 'in', 'beco' ),
		__( 'Edit', 'beco' ),
	);
}
